...
class Order(models.Model):
    ...
    created_timestamp = models.DateTimeField(auto_now_add=True, verbose_name="Date of the order creation")
    phone_number = models.CharField(max_length=20, verbose_name="Phone number")
    requires_delivery = models.BooleanField(default=False, verbose_name="Delivery is required")
    ...
    is_paid = models.BooleanField(default=False, verbose_name="Paid for")
